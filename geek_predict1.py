...
class GeekDataset(t.utils.data.Dataset):
...
class Net(t.nn.Module):
    def __init__(self):
        ...
        self.hid1 = t.nn.Linear(48, 100)  # 48-(100-100-100)-1
...
def main():
    ...
    for uarch in range(5):
        ...
        for rep in range(1, num_reps+1):
            ...
            train_ds = GeekDataset(train_df)
            test_ds = GeekDataset(test_df)
            ...
            # path = f"./Case1/GeekLog/Uarch{uarch}_Rep{rep}.pth"
            # info_dict = {
            #    'repetition': rep,
